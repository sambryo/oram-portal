#this file contains all the steps related to creating a referral, accepting one, and viewing one.
# This will be a gradual refactoring as I go.
# - Alice

#this was taken from the client_referral_steps; it is when a client fills out a referral form.
