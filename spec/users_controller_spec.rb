...
RSpec.describe UsersController, type: :controller do
  ...
  it "should return the correct Turkey legal status" do 
    expect(subject.current_user.turkey_legal_status).to eq(["Undocumented", "Legal Temporary Resident (Non-Citizen)", "Legal Long-Term Resident (Non-Citizen)", "Legal Citizen", "Unsure"])
  end
